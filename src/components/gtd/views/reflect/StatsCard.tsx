...
const StatCount: React.FC<StatCountProps> = ({
  value,
  label,
  color
}) => <div>
      ...
      <CardContent>
        <div className="mb-6">
          ...
          <div className="flex justify-around text-center">
            <StatCount value={taskCounts.nextActions} label="Next Actions" color="text-blue-500" />
            <StatCount value={taskCounts.projects} label="Projects" color="text-purple-500" />
            <StatCount value={taskCounts.waitingFor} label="Waiting For" color="text-green-500" />
          </div>
        </div>
