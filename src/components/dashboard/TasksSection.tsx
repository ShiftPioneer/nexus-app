      ...
      <CardContent>
        {tasks.length === 0 ? (
          <EmptyState
            ...
            description="You have no tasks scheduled for today. Time to plan or relax!"
            action={
              <Button 
                variant="outline" 
                size="sm" 
            ...
            {tasks.slice(0, 5).map((task, index) => (
              ...
              >
                <button 
                  ...
                  className="flex-shrink-0 w-6 h-6 rounded-full border-2 border-slate-600 group-hover:border-green-500 flex items-center justify-center transition-colors duration-200" 
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    ...
                    {task.dueDate && (
                      <Badge variant="secondary" className="text-xs bg-slate-700 text-slate-300 border-transparent">
