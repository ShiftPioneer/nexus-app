  ...
  return <Card className="border-slate-300">
      ...
      <CardContent className="bg-slate-950 rounded-lg">
        {tasks.length === 0 ? <div className="text-center py-8">
            ...
            {tasks.slice(0, 5).map(task => <div key={task.id} className="flex items-center justify-between p-3 rounded-lg border border-slate-300 bg-card hover:bg-accent/50 transition-colors">
