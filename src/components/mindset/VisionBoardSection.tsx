    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
            ...
            <Card className="mb-6 border-dashed">
              <CardContent className="p-4 space-y-4">
                <div className="flex justify-center">
                  {!uploadedImage ? (
                    <div 
                      className="w-full h-48 bg-accent/10 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-accent/20 transition-colors"
          ...
          {visionItems.length === 0 && !isAddingNewItem ? (
