...
>(({ className, gradient, icon: Icon, children, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "group relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl px-6 py-3 text-sm font-semibold transition-all duration-300 overflow-hidden",
  ...
  >
    ...
    <div className={cn(
      "absolute inset-0 opacity-0 group-data-[state=active]:opacity-20 transition-opacity duration-300",
    ...
    {Icon && (
      <div className={cn(
        "relative flex items-center justify-center w-5 h-5 rounded-lg transition-all duration-300",
