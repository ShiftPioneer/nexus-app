...
const TimeDesignAnalytics: React.FC<TimeDesignAnalyticsProps> = ({ activities }) => {
          ...
          <div className="w-44 h-44 relative">
            ...
            <svg viewBox="0 0 100 100" className="w-full h-full">
              ...
              <circle
                ...
                stroke="#a78bfa"
                strokeWidth="20"
                strokeDasharray={`${productiveTime.work} ${100 - productiveTime.work}`}
                transform="rotate(-90 50 50)"
              />
              {/* Learning segment - Blue */}
              <circle
                ...
                stroke="#60a5fa"
                strokeWidth="20"
                strokeDasharray={`${productiveTime.learning} ${100 - productiveTime.learning}`}
                strokeDashoffset={`${-productiveTime.work}`}
                transform="rotate(-90 50 50)"
              />
            </svg>
          </div>
          ...
          <div className="w-44 h-44 relative">
            ...
            <svg viewBox="0 0 100 100" className="w-full h-full">
              ...
              <circle
                ...
                stroke="#fb923c"
                strokeWidth="20"
                strokeDasharray={`${personalTime.social} ${100 - personalTime.social}`}
                transform="rotate(-90 50 50)"
              />
              {/* Health segment - Green */}
              <circle
                ...
                stroke="#4ade80"
                strokeWidth="20"
                strokeDasharray={`${personalTime.health} ${100 - personalTime.health}`}
                strokeDashoffset={`${-personalTime.social}`}
                transform="rotate(-90 50 50)"
              />
            </svg>
          </div>
