        ...
        <GTDProvider>
          ...
          <div className="flex flex-col flex-1 overflow-hidden transition-all duration-500 ease-in-out">
            ...
            <main className="flex-1 overflow-y-auto scrollbar-none bg-slate-900">
              <div className="h-full w-full p-4 bg-slate-900">
                {children}
              </div>
            </main>
          </div>
          ...
          {/* Mobile Overlay */}
          {isMobile && !isCollapsed && <div className="fixed inset-0 bg-black bg-opacity-50 z-40 md:hidden" onClick={toggleSidebar} />}
        </GTDProvider>
      </SidebarProvider>
    </div>;
};
