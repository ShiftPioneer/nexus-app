  ...
  return (
    <div className="relative h-screen">
      <ShadcnSidebar 
        variant="sidebar" 
        className={cn(
          "transition-all duration-300 bg-[#1A1F2C] text-white border-r border-[#2A2F3C]",
        ...
        <SidebarRail className="bg-[#1A1F2C]">
          <div className="h-full flex flex-col justify-between">
            <div className="flex justify-center py-4">
              {isCollapsed && (
                <div className="flex justify-center items-center cursor-pointer" onClick={handleToggleCollapse}>
                  <ChevronRight className="h-5 w-5 text-[#0FA0CE]" />
                </div>
              )}
            </div>
          </div>
